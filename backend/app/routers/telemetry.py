...
# Se inicializa en el primer uso; el pool de conexiones asyncpg reutiliza
# conexiones para no abrir/cerrar una por cada punto de telemetría.
...
async def _publish_to_redis(payload: TelemetryIngest) -> None:
    ...
    Usa el cliente singleton de módulo para no abrir/cerrar conexiones en cada punto.
    """
    try:
        message = {
            "drone_id":    str(payload.drone_id),
