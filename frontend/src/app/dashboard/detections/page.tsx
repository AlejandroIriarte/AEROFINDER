// =============================================================================
// AEROFINDER Frontend — Historial de detecciones (solo lectura)
// Tabla paginada con filtros por misión y tipo.
// Confirmar/descartar va en /dashboard/alerts.
// =============================================================================
...
export default function DetectionsPage() {
  ...
  return (
    <div className="p-5">
      <PageHeader title="Detecciones" subtitle="Historial de detecciones de personas por IA" />
