...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Revisión de casos", href: "/dashboard/admin/pending-review", roles: ["admin", "ayudante"] },
  ...
  { label: "Detecciones",     href: "/dashboard/detections",             roles: ["admin", "buscador", "ayudante"] },
  { label: "Drones",          href: "/dashboard/drones",                roles: ["admin", "buscador"] },
  { label: "Usuarios",        href: "/dashboard/users",                 roles: ["admin"] },
  { label: "Alertas",         href: "/dashboard/alerts",                roles: ["admin", "buscador", "ayudante"] },
  { label: "Configuración",   href: "/dashboard/config",                roles: ["admin"] },
  { label: "Auditoría",       href: "/dashboard/logs",                  roles: ["admin"] },
  { label: "Reportar",        href: "/dashboard/familiar/report",       roles: ["familiar"] },
  { label: "Mis casos",       href: "/dashboard/familiar",              roles: ["familiar"] },
    ...
    <aside className="flex h-screen w-56 flex-col bg-gray-900 text-gray-100 shadow-lg">
      ...
      <div className="border-t border-gray-700 px-4 py-4">
        <div className="mb-3 flex items-center justify-between">
          <p className="truncate text-[11px] text-gray-500">{userName}</p>
